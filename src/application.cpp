...
{
    if (TEST_VERSION) // date limit for test version
    {
        ...
        if (date_now > date_limit)
        {
            ...
            msg_box.setText("<style>a {text-decoration: none; color: blue}</style>This is a very old beta version. Please check for updates <a href='https://pvz.lmintlcx.com/getpvztools/'>here</a>. <br>这是很旧很旧的测试版哦, 去 <a href='https://pvz.lmintlcx.com/getpvztools/'>这里</a> 下载最新版吧.");
            msg_box.exec();
