...
- 购买商店物品不再包括钉耙.
- 巧克力和树肥的数量上限修正为 10.
- 默认无尽轮数更新为 1010. (1010x2+2=2022)


## [2.6.0] - 2021/08/15

- 获得金向或者临时解锁后会自动刷新主界面.
- 检测到不支持的版本时提示下载 PvZ Toolkit.
- 默认显示新的阵型字符串格式.
- 默认金币 99999, 默认智慧树高度 1437.
- 卡槽页面, 新增"置顶卡槽"功能.
- 帮助菜单, 移除了"帮助文档"和"发送反馈".


## [2.5.1] - 2020/12/04

- 默认主题还原为 WindowsVista.
- 内置阵型列表小幅更新.
